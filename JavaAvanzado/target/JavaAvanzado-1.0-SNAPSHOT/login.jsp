    ...
    <section>
        <form action="" method="" class="form_style">
            ...
            <div class="form-floating mb-5">
                <input type="email" class="form-control" id="floatingInput" required autofocus oninvalid="setCustomValidity('Esta campo es obligatorio')" placeholder=" write your name please" pattern="[A-Z a-z]{4,50}">
